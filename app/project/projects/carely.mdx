---
title: Carely
summary: Care-coordination and case management made easy.
...
<b>Note</b>: This project is a piece of a pie, me and my team members
contributed to during the summer. There were 4-5 different teams including ours,
...
<table>
  ...
  <tr>
    ...
    <td>
      Access patient information to build personalized case plan, and perform
      risk evaluation
    </td>
  </tr>
  <tr>
    ...
    <td>Provide services to fit patient needs.</td>
  </tr>
  <tr>
    <td>4.</td>
    <td>Care-givers</td>
    <td>Access health information, and review cases.</td>
  </tr>
  <tr>
    <td>5.</td>
    <td>Case managers</td>
    <td>
      Maintains external data, determines plan objectives and suggests health
      recommendations.
    </td>
  </tr>
  <tr>
    ...
    <td>PM/BA&#39;s</td>
    <td>
      Responsible for gathering and prioritizing requirements of the case notes
      system.
    </td>
  </tr>
  <tr>
    ...
    <td>
      Responsible for design and implementation of the case notes backend and
      frontend system.
    </td>
  </tr>
</table>
...
3. <b>Observation statement</b> - Differentiate one customer from another (Objective
   - facts).
...
7. <b>Plan statement</b> - should include next steps assignment. - Should include
