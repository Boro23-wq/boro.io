...
summary: Improved import statements with absolute paths using babel plugins.
...
Relative import statements are a pain. To avoid `../` chains, improve code portability, and type less, I've started using [babelplugin-module-resolver](https://github.com/tleunen/babel-plugin-module-resolver) in my Next.js projects.
