...
<b>Goal</b>: The purpose of this project is to learn how to use the Amazon AWS
...
<b>Description</b>: We are building an image recognition pipeline in AWS, using
...
4. Once you have the JAR files ready you can upload it to the respective EC2 instances using <b>Cyberduck</b> (Mac) or <b>WinSCP</b> (Windows). I am using Cyberduck for the project since I'm working with a Mac system.
   ...
   - <b>Note</b> The username while you FTP to your EC2 instance using Cyberduck
     should be 'ec2-user'.
